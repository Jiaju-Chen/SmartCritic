...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(
        ...
        attn_implementation = "flash_attention_2" if (use_remove_padding or use_fused_kernels) else "sdpa"
...
class RewardModelWorker(Worker):
    ...
    def _forward_micro_batch(self, micro_batch):
        if is_cuda_available:
            from verl.utils.bert_padding_compat import index_first_axis, pad_input, rearrange, unpad_input
