...
job_id=$(sbatch --parsable \
  ...
  --export="ALL,ADVANTAGE_COMPOSITION=residual,RUN_NAME=ppo_qwen25_15b_luna_residual2h_alfworld_t128_v140_vb20_a800x4_smoke3_20260823,WANDB_RUN_ID=lunaa8004smoke3_0823,WANDB_MODE=offline,N_GPUS_PER_NODE=4,ROLLOUT_TP_SIZE=2,RAY_NUM_CPUS=64,NUM_CPUS_PER_ENV_WORKER=0.25,TOTAL_EPOCHS=1,TRAIN_DATA_SIZE=128,VAL_DATA_SIZE=140,VAL_BATCH_SIZE=20,PPO_MINI_BATCH_SIZE=256,TEST_FREQ=1,SAVE_FREQ=1,VAL_BEFORE_TRAIN=False" \
