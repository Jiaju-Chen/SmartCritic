...
RAY_TMP_ROOT=${RAY_TMP_ROOT:-/home/dataset-local/cjj/hygae_turnend_r}
FAST_TMP_ROOT=${FAST_TMP_ROOT:-/home/dataset-local/cjj/hygae_turnend_t}
...
export WANDB_RUN_ID=${WANDB_RUN_ID:-hygaete10_0817}
...
TOKEN_LAM=${TOKEN_LAM:-1.0}
TURN_LAM=${TURN_LAM:-1.0}
...
bash examples/ppo_trainer/run_alfworld.sh vllm \
  ...
  algorithm.lam=$TOKEN_LAM \
  algorithm.hygae.alpha=0.5 \
  algorithm.hygae.turn_lam=$TURN_LAM \
