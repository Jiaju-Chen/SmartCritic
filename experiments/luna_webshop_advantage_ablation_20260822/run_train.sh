...
CKPT_DIR=${CKPT_DIR:-/home/dataset-local/cjj/RL/checkpoints/luna_webshop_advantage_ablation/$RUN_NAME}
...
RAY_TMP_ROOT=${RAY_TMP_ROOT:-/home/dataset-local/cjj/lwa_r}
FAST_TMP_ROOT=${FAST_TMP_ROOT:-/home/dataset-local/cjj/lwa_t}
mkdir -p "$RUN_DIR"/{home,logs,wandb} "$CKPT_DIR" "$RAY_TMP_ROOT" "$FAST_TMP_ROOT"

bash experiments/luna_webshop_advantage_ablation_20260822/prepare_resources.sh
...
export WANDB_RUN_ID=${WANDB_RUN_ID:-lunawsdirect_0822}
...
python -m verl.trainer.main_ppo \
  ...
  algorithm.hybrid_advantage.composition_mode="$ADVANTAGE_COMPOSITION" \
