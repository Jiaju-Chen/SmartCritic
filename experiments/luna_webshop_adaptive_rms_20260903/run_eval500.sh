...
BASE_EVAL=$PROJECT_ROOT/experiments/luna_webshop_gamma_alpha_20260902/run_eval500.sh
TRAIN_RUN_NAME=${TRAIN_RUN_NAME:-luna_webshop_adaptive_rms_rho05_beta09_t128_v128_8gpu_seed0_20260903}
...
env \
  ...
  EXPERIMENT_ID=adaptive_rms_rho05 \
  ALPHA=1.0 \
  ...
  WANDB_RUN_ID="${WANDB_RUN_ID:-lzwsrms05e500_0903}" \
  RUN_BASE="$RUN_BASE" \
  CKPT_BASE="$CKPT_BASE" \
  "$BASE_EVAL"
