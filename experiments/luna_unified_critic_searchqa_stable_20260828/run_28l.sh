...
RUN_NAME=${RUN_NAME:-ppo_qwen25_15b_luna_unified28l_residual_searchr1_stable_8gpu_seed0_200it_20260828}
...
export RUN_NAME
export RUN_ROOT
export WANDB_RUN_ID=${WANDB_RUN_ID:-lunasearchr1_stable28l_0828}
...
bash experiments/luna_unified_critic_searchqa_28l_20260827/run_formal_28l.sh \
