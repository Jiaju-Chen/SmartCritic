...
export RUN_NAME=${RUN_NAME:-luna_unified_searchqa_2l_direct_whiten_8gpu_t256_v512_200step_20260901}
...
export WANDB_RUN_ID=${WANDB_RUN_ID:-lunauni8directw0901}
...
export RAY_TMP_ROOT=/dev/shm/scq-luna8-direct-white-ray
export FAST_TMP_ROOT=/dev/shm/scq-luna8-direct-white-tmp
export VAL_FILE="$RUN_ROOT/val_subsets/searchqa_test_stratified512_seed0.parquet"
export SESSION_NAME=${SESSION_NAME:-searchqa_luna2l_direct_whiten_20260901}
