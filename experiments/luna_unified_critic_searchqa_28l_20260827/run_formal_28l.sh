...
RUN_NAME=${RUN_NAME:-ppo_qwen25_15b_luna_unified28l_residual_searchr1_official_8gpu_seed0_200it_tokengamma1_20260827}
...
RAY_TMP_ROOT=${RAY_TMP_ROOT:-/dev/shm/cjj_luna_searchr1_28l_ray}
FAST_TMP_ROOT=${FAST_TMP_ROOT:-/dev/shm/cjj_luna_searchr1_28l_tmp}
...
export WANDB_RUN_ID=${WANDB_RUN_ID:-lunasearchr1_28l_0827}
...
python -m verl.trainer.main_ppo \
  ...
  +critic.model.override_config.num_hidden_layers=28 \
