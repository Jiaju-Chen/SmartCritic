...
CKPT_DIR=${CKPT_DIR:-/home/dataset-local/cjj/RL/checkpoints/luna_unified_webshop/$RUN_NAME}
...
RAY_TMP_ROOT=${RAY_TMP_ROOT:-/home/dataset-local/cjj/luw_r}
FAST_TMP_ROOT=${FAST_TMP_ROOT:-/home/dataset-local/cjj/luw_t}
mkdir -p "$RUN_DIR"/{home,logs,wandb} "$CKPT_DIR" "$RAY_TMP_ROOT" "$FAST_TMP_ROOT"

bash experiments/luna_unified_critic_webshop_20260821/prepare_resources.sh
